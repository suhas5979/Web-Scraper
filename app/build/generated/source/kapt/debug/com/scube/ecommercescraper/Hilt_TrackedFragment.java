...
public abstract class Hilt_TrackedFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_TrackedFragment() {
    super();
  }

  Hilt_TrackedFragment(int contentLayoutId) {
  ...
  protected void inject() {
    ((TrackedFragment_GeneratedInjector) generatedComponent()).injectTrackedFragment(UnsafeCasts.<TrackedFragment>unsafeCast(this));
  }
